...
function autoloader( $resource = '' ) {
	$resource_path  = false;
	$namespace_root = 'CATHERINE_THEME\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( CATHERINE_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\CATHERINE_THEME\Inc\Helpers\autoloader' );