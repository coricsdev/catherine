...
class Block_Patterns {
	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'CATHERINE/cover',
				[
					'title' => __( 'CATHERINE Cover', 'CATHERINE' ),
					'description' => __( 'CATHERINE Cover Block with image and text', 'CATHERINE' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'CATHERINE/two-columns',
				[
					'title' => __( 'CATHERINE Two Column', 'CATHERINE' ),
					'description' => __( 'CATHERINE two columns with heading and text', 'CATHERINE' ),
					'categories' => [ 'columns' ],
	...
	public function register_block_pattern_categories() {
		...
		$pattern_categories = [
			'cover' => __( 'Cover', 'CATHERINE' ),
			'columns' => __( 'Columns', 'CATHERINE' ),
		];
