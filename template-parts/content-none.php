...
<section class="no-result not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'CATHERINE' ); ?></h1>
	</header>
	...
	<div class="page-content">
		<?php
			...
			<?php
				...
				?>
				<p><?php esc_html_e( 'It seems that we cannot find what you are looking for . Perhaps search can help', 'CATHERINE'  ); ?></p>
				<?php
				get_search_form();
			}
		?>
