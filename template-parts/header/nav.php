...
$menu_class = \Catherine_Theme\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id( 'catherine-header-menu' );
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <!--  Add the custom logo to the header -->
   <?php 
