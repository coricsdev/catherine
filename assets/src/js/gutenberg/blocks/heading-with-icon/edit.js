...
const Edit = ( props ) => {
	...
	return (
		<div className="CATHERINE-icon-heading">
			<span className="CATHERINE-icon-heading__heading">
				<HeadingIcon />
			</span>
			...
			<RichText
				...
				placeholder={ __( 'Heading…', 'CATHERINE' ) } // Display this text before any content has been added by the user
			/>
			<InspectorControls>
				<PanelBody title={ __( 'Block Settings', 'CATHERINE' ) }>
					<RadioControl
						label={ __( 'Select the icon', 'CATHERINE' ) }
						help={ __( 'Controls icon selection', 'CATHERINE' ) }
						selected={ option }
						options={ [
							{ label: 'Dos', value: 'dos' },
